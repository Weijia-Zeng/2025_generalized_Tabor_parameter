...
% macroscopic dimensionless parameters
Adh     = 1;
P       = 0;
T       = lambda_E^2/lambda_T/Rs_micro^2;
...
RF1      = zeros(n,1);
A0      = 0.00015*Rs;
RA      = logspace(log10(A0),log10(Rs/1.2),n);
...
if P ~= 0
    ...
    ratio2 = 2*delta0/Rf^2;         % kappa_membrane/(1/Rs)
...
filename = ['F_H_data_JKR_lambdaT_',num2str(lambda_T),'.mat'];
save(filename)
